...
const products = {
    ...
    mouses: [
        ...
        },
        {
            ...
            value: 101.54,
            description: 'Sensor PIXART PMW3325 para Alta Performance (10000 DPI/20G/100ips). Iluminação RGB Ajustável: Sistema de Iluminação Chroma RGB! (7 Diferentes Modos de Iluminação). Polling Rate de 1000hz (Tempo de Resposta Ajustável via Software de 1/2/4/8ms). 7 Botões Programáveis. 2 Botões Laterais para funções / atalhos, macros e etc. Compatível com Software para Configuração de Macro / Ajuste Iluminação RGB / Configurações de Performance. Memória Interna para Salvamento de Configurações.',
            evaluation: 3,
            brand: "Redragon",
            urls: [
                "https://m.media-amazon.com/images/I/61mPlkAdz5L._AC_SL1500_.jpg",
            ]
        },
        {
            id: 12,
            name: 'Mouse Gamer Logitech G203 Lightsync Rgb, Efeito de Ondas de Cores, 6 Botões Programáveis e Até 8.000 DPI - Lilás',
            value: 99.99,
            description: 'Mouse Gamer Logitech G203 LIGHTSYNC RGB, Efeito de Ondas de Cores, 6 Botões Programáveis e Até 8.000 DPI - Lilás',
            evaluation: 4,
            brand: "Logitech",
            urls: [
                "https://m.media-amazon.com/images/I/61X6883m7wL._AC_SL1500_.jpg",
            ]
        },
        {
            id: 13,
            name: 'Redragon MOUSE GAMER GRIFFIN PRETO COM LED RGB - M607, UNICO',
            value: 184.99,
            description: 'Mouse gamer redragon griffin preto com led rgb - m607',
            evaluation: 4.5,
            brand: "Redragon",
            urls: [
                "https://m.media-amazon.com/images/I/6177U5fDSwL._AC_SL1500_.jpg",
            ]
        },
        {
            id: 14,
            name: 'Mouse Gamer HyperX Pulsefire Haste, RGB, 16000 DPI, White / Pink - HMSH1-A-WT/G - 4P5E4AA',
            value: 199.99,
            description: 'Pulsefire Haste é fabricado com a estrutura em design de favos de mel que torna o mouse mais leve do que um mouse de estrutura sólida, sem comprometer sua durabilidade. O desenho de malha aberta também permite melhor ventilação e fluxo de ar.',
            evaluation: 3.3,
            brand: "HyperX",
            urls: [
                "https://images.kabum.com.br/produtos/fotos/371588/haste-hyperx-pulsefire-wtpk-hmsh1-a-wt-g-4p5e4aa_1659035473_gg.jpg",
            ]
        },
        {
            id: 15,
            name: 'Mouse sem fio Logitech MX Vertical com Design Ergonômico, USB Unifying ou Bluetooth para até 3 dispositivos, Recarregável',
            value: 535.40,
            description: 'O MX Vertical é um mouse ergonômico avançado que combina design criado de forma científica com desempenho elevado da série MX da Logitech. A posição natural do aperto de mão reduz a pressão no pulso e a tensão no antebraço. O exclusivo ângulo vertical de 57° foi otimizado para oferecer uma postura ergonômica sem comprometer um pixel de desempenho. O sensor de alta precisão de 4000 DPI do mouse resulta em quatro vezes menos movimentos das mãos e reduz a fadiga. E o botão de velocidade do cursor permite que você ajuste instantaneamente a velocidade e a precisão de DPI rapidamente. O MX vertical permanece carregado por até quatro meses com carga total - e oferece três horas de uso com uma carga rápida de um minuto.',
            evaluation: 5,
            brand: "Logitech",
            urls: [
                "https://m.media-amazon.com/images/I/71P5QJEcfRL._AC_SL1500_.jpg",
            ]
        },
        {
            id: 16,
            name: 'MOUSE GAMER CORSAIR M55 RGB PRO 12400DPI BRANCO, CH-9308111-NA',
            value: 150.00,
    ...
    keyboard: [
        {
            id: 17,
            name: 'Teclado SIGNATURE K650',
            value: 299.00,
            description: "O SIGNATURE K650 se encaixa perfeitamente em suas necessidades diárias com teclas de atalhos e apoio para as mãos integrado. Tenha o conforto de que precisa por longas horas em sua mesa. Com um design resistente a derramamentos* e fácil de limpar e até 36 meses de vida útil da bateria**, você pode movê-lo de forma conveniente e fácil sem fios no caminho.",
            evaluation: 4,
            brand: 'Logitech',
            urls: [
                ...
                "https://resource.logitech.com/w_80,h_50,c_limit,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/logitech/en/products/keyboards/k650-signature-wireless-keyboard/gallery/k650-bottom-off-white.png?v=1",
            ]

        },
        {
            id: 18,
            name: 'HyperX Alloy Origins Core PBT HX Vermelho - Teclado gamer mecânico',
            value: 184.99,
            description: 'Esses conjuntos de teclas PBT oferecem uma ótima sensação e são ainda mais duráveis. A impressão lateral nas teclas ajuda a garantir que funções importantes do teclado sejam facilmente visíveis com menos desgaste ao longo do tempo.',
            evaluation: 2,
            brand: "HyperX",
            urls: [
                "https://cdn.shopify.com/s/files/1/0564/3612/9997/products/hyperx_alloy_origins_core_pbt_english_us_blue_1_main_900x.jpg?v=1663889002",
            ]
        },
        {
            id: 19,
            name: 'K60 RGB PRO Low Profile Mechanical Gaming Keyboard — CHERRY® MX Low Profile Speed',
            value: 300.00,
        ...
        {
            id: 20,
            name: 'Teclado Gamer Kumara K552W Rgb Branco Outemu Brown Redragon',
            value: 184.99,
            description: 'O teclado mecânico gamerKumarada Redragon, traz todo poder dos teclados mecânicos para seu setup, com o sistema N-Key Rollover, para efeito Anti-Ghosting em todas as teclas, utiliza os renomados switches mecânicos Outemu Brown sem clique audível, ativação tátil, resistência média',
            evaluation: 3,
            brand: "Redragon",
            urls: [
                "https://m.media-amazon.com/images/I/61+J3sskSxL._AC_SL1500_.jpg",
            ]
        },
        {
            id: 21,
            ...
            value: 499.99,
            description: 'A experiência de digitação mais avançada da Logitech até agora. O MX Keys combina teclas trabalhadas com iluminação inteligente e uma construção impressionantemente sólida.',
            evaluation: 2,
            brand: "Logitech",
            urls: [
        ...
        {
            id: 22,
            name: 'Teclado gamer K55 RGB PRO XT',
            value: 184.99,
        ...
        {
            id: 23,
            name: 'Teclado Mecânico Redragon RGB Fizz K617',
            value: 439.99,
            description: 'O Teclado Mecânico Redragon RGB Fizz K617 com seus Switches Red te dá a precisão que precisa pros seus jogos, além de ocupar pouco espaço e ter um RGB totalmente personalizável. Tudo isso em um único teclado e a um preço extraordinário.',
            evaluation: 4,
            brand: "Redragon",
            urls: [
                "https://cf.shopee.com.br/file/e7374569c30c026b8cb7e74910482c51",
            ]
        },
        {
            id: 24,
            name: 'HyperX Alloy Origins 65 - Teclado mecânico gamer',
            value: 299.99,
            description: 'Um equilíbrio otimizado de compacidade e funcionalidade. Com 65% do formato original, ele libera mais espaço para o mouse do que um teclado tenkeyless, mas mantém as teclas de seta dedicadas, Page Up/Down, Home e Delete.',
            evaluation: 5,
            brand: "HyperX",
            urls: [
                "https://cdn.shopify.com/s/files/1/0564/3612/9997/products/hyperx_alloy_origins_65_english_us_aqua_1_top_down_900x.jpg?v=1665613630",
            ]
        },
